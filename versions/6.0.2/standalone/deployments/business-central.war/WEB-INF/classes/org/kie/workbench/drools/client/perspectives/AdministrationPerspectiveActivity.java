...
@Named("org.kie.workbench.drools.client.perspectives.AdministrationPerspective")
/*
...
public class AdministrationPerspectiveActivity extends AbstractWorkbenchPerspectiveActivity {
    ...
    public AdministrationPerspectiveActivity(final PlaceManager placeManager) {
        super( placeManager );
    }

    @Override
    public String getIdentifier() {
        return "org.kie.workbench.drools.client.perspectives.AdministrationPerspective";
    }
    ...
    public String getSignatureId() {
        return "org.kie.workbench.drools.client.perspectives.AdministrationPerspectiveActivity";
    }
}
